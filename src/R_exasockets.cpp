...
#include <Rcpp.h>
#ifdef _WIN32
#undef Realloc // Realloc of the Windows SDK gets overwritte by R.h; see http://stackoverflow.com/questions/11588765/using-rcpp-with-windows-specific-includes
#undef Free
#endif
